...
The mean of the total steps per day is `r stepsMean`.
The median of the total steps per day is `r stepsMedian`.
...
```
The interval, `r maxAverageStepsRowID` has the maximum average steps
